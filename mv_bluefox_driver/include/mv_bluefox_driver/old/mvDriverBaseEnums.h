...
//-----------------------------------------------------------------------------
/// \brief Defines valid event state.
///
...
//-----------------------------------------------------------------------------
{
	...
	/// manager has been connected to the system.
	detPnPArrival = 0x1,
	/// \brief An event of this type will be signalled (<b>if desired</b>) each time a
	/// hotplug compliant device recognized by the mvIMPACT acquire device 
	/// manager has been disconnected to the system.
	detPnPRemoval = 0x2,
...
//-----------------------------------------------------------------------------
{
	/// \brief A generic interface layout shall be used. \b deprecated
	///
