...
public:
	...
	/// when this data shall be wriiten to the property. To find out how much binary data can be stored
	...
	/// the value by a previous call to <b>mvIMPACT::acquire::PropertyS::writeBinary</b>.
...
public:
	...
	explicit EventWaitResults(	/// The error code returned by the wait function
								...
								TDeviceEventType resultMask ) : m_errorCode(errorCode),	m_waitMask(waitMask), m_resultMask(resultMask) {}
...
public:
	...
	explicit EventSubSystem(	/// A pointer to a <b>mvIMPACT::acquire::Device</b> object obtained from a <b>mvIMPACT::acquire::DeviceManager</b> object.
								Device* pDev ) : m_pRefData(0)
	{
		if( !pDev->isOpen() )
		{
	...
	/// \brief Allows to wait for the occurrence of one or more events.
	///
	...
	EventWaitResults waitFor(	/// The timeout in ms defining the maximum time to be spend waiting
								int timeout_ms,
...
public:
	...
	explicit ImageProcessing(	/// A constant reference to the <b>mvIMPACT::acquire::ImageProcessing</b> object, this object shall be created from
								const ImageProcessing& src ) : ComponentCollection(src), m_pRefData(src.m_pRefData),
								  ...
								  tapSortEnable(src.tapSortEnable)
	{
		++(m_pRefData->m_refCnt);
	}
	/// \brief Class destructor.
